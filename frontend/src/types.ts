import { Check, MessageSquareWarningIcon, Timer } from "lucide-react";
...
export const MessageStatuses = [
  { key: "pending", value: "Pending", icon: Timer },
  { key: "sent", value: "Sent", icon: Check },
  { key: "deleted", value: "Deletedt", icon: Check },
  { key: "failed", value: "Failedt", icon: MessageSquareWarningIcon },
] as const;

export type MessageStatus = (typeof MessageStatuses)[number]["key"];
